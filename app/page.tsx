            ...
            <div className=" container mx-auto flex flex-wrap md:p-5 flex-col md:flex-row items-center">
              <a className="max-sm:fixed flex title-font font-medium items-center text-gray-900 md:mb-0">
                ...
                <div className="max-sm:mt-32 max-sm:container md:ml-auto md:mr-auto flex items-center text-base justify-center gap-2">
                  <Link title="Cuantoto : Daftar Slot Online Dan Slot Online Terpercaya" href='https://daftarwap.orang-dalam.link/18' target="_blank" className='text-center w-52 max-sm:w-9/12 font-bold text-black px-6 py-2 border-2 border-[#FFFE00] rounded-sm bg-gradient-to-r from-[#FFA200] via-[#FFC300] to-[#ffa200]'>
                      LOGIN
                  </Link>
                  <Link title="Cuantoto : Daftar Slot Online Dan Slot Online Terpercaya" href='https://daftarwap.orang-dalam.link/18' target="_blank" className='text-center w-52 max-sm:w-9/12 font-bold text-black px-6 py-2 border-2 border-[#FFFE00] rounded-sm bg-gradient-to-r from-[#FFA200] via-[#FFC300] to-[#ffa200]'>
                      DAFTAR
