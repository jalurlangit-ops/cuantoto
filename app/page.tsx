        ...
        <div className='mx-auto lg:w-2/3'>
            <div className=" container mx-auto flex flex-wrap md:p-5 flex-col md:flex-row items-center">
              <a className="max-sm:fixed flex title-font font-medium items-center text-gray-900 md:mb-0">
                <Image alt="cuantoto slot" src='/logo.png' className='w-48 md:w-52 block' width='230' height='80' />
              </a>
                <div className="max-sm:mt-32 max-sm:container md:ml-auto md:mr-auto flex items-center text-base justify-center gap-2">
                  <Link title="Cuantoto : Daftar Slot Online Dan Slot Online Terpercaya" href='https://daftarwap.orang-dalam.link/cuan' target="_blank" className='text-center w-52 max-sm:w-9/12 font-bold text-black px-6 py-2 border-2 border-[#FFFE00] rounded-sm bg-gradient-to-r from-[#FFA200] via-[#FFC300] to-[#ffa200]'>
                      LOGIN
                  </Link>
                  <Link title="Cuantoto : Daftar Slot Online Dan Slot Online Terpercaya" href='https://daftarwap.orang-dalam.link/cuan' target="_blank" className='text-center w-52 max-sm:w-9/12 font-bold text-black px-6 py-2 border-2 border-[#FFFE00] rounded-sm bg-gradient-to-r from-[#FFA200] via-[#FFC300] to-[#ffa200]'>
                      DAFTAR
          ...
          <Image alt="Cuantoto : Daftar Slot Online Dan Slot Online Terpercaya" src='/banner.png' className='max-sm:mt-12 w-full block' width={757} height={411} />
          <h1 className='my-6 text-center'>Cuantoto : Daftar Slot Online Dan Slot Online Terpercaya</h1>
          <div className='p-6 space-y-6 rounded-md glow-yellow mb-40'>
                      ...
                      <thead className='font-medium border-b border-[#EACD00] bg-gradient-to-r from-[#2E2E2E] via-[#606060] to-[#2E2E2E] '>
                        <tr>
                          <th colSpan={2} scope='col' className='px-6 py-3 text-center border-2 border-e border-[#EACD00] '>
                            <h2>Informasi cuantoto Agen Slot Maxwin Online</h2>
                          </th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr className='border-b border-[#EACD00] grid-cols-4'>
                          ...
                          <td className='px-2 py-3 w-3/4 whitespace-nowrap border-e border-[#EACD00] '>cuantoto</td>
                        </tr>
                        ...
                        <tr className='border-b border-[#EACD00] '>
                          ...
                          <td className='px-2 py-3 w-3/4 whitespace-nowrap border-e border-[#EACD00] '>
                            <Link href='https://daftarwap.orang-dalam.link/cuan' target="_blank">
                              Klik disini
                            </Link>
                          </td>
                        </tr>
            ...
            <ul className='text-[#FFD700] ml-4 leading-loose'>
              <li className='list-disc'>cuantoto</li>
          ...
          <div className='bg-[#5B5B5B] text-center py-4'>
            <p className='text-sm text-white font-medium'>Copyright &copy; 2025 - Cuantoto : Daftar Slot Online Dan Slot Online Terpercaya </p>
          </div>
        </div>
      </div>
    </main>
